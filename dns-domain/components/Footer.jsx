...
const Footer = () => {
  ...
  return (
    <div className="bg-footer-gradient">
      <div className="bg-contain h-auto bg-center w-full py-5 md:px-12 md:pt-12">
        <div className="container mx-auto">
          ...
          <div
            className="h-auto pt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 flex-wrap container w-full"
          >
      ...
      <hr className="h-[0.5px] bg-white-200 w-full border-none mt-8 md:mt-20" />
      <div className="h-auto flex flex-wrap align-middle justify-evenly gap-5 py-2   md:gap-10 px-5 md:py-4">
        ...
        <div className="flex flex-wrap align-middle justify-center xs:gap-3 sm:gap-4 h-auto my-auto">
          <Link href="/social1">
